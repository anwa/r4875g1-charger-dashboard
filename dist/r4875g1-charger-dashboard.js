...
const { is: ft, defineProperty: gt, getOwnPropertyDescriptor: $t, getOwnPropertyNames: _t, getOwnPropertySymbols: mt, getPrototypeOf: yt } = Object, O = globalThis, W = O.trustedTypes, vt = W ? W.emptyScript : "", At = O.reactiveElementPolyfillSupport, E = (r, t) => r, T = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? vt : null;
      break;
...
y.elementStyles = [], y.shadowRootOptions = { mode: "open" }, y[E("elementProperties")] = /* @__PURE__ */ new Map(), y[E("finalized")] = /* @__PURE__ */ new Map(), At?.({ ReactiveElement: y }), (O.reactiveElementVersions ??= []).push("2.1.2");
...
\f\r]`, S = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, J = /-->/g, K = />/g, $ = RegExp(`>|${H}(?:([^\\s"'>=/]+)(${H}*=${H}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), F = /'/g, Q = /"/g, ot = /^(?:script|style|textarea|title)$/i, Et = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), C = Et(1), A = /* @__PURE__ */ Symbol.for("lit-noChange"), d = /* @__PURE__ */ Symbol.for("lit-nothing"), X = /* @__PURE__ */ new WeakMap(), _ = m.createTreeWalker(m, 129);
function at(r, t) {
...
const Ct = (r, t) => {
  ...
  for (let h = 0; h < e; h++) {
    ...
    n += o === S ? a + bt : c >= 0 ? (s.push(l), a.slice(0, c) + rt + a.slice(c) + g + f) : a + g + (c === -2 ? h : f);
  }
...
class P {
  ...
  _$AI(t, e = this) {
    t = b(this, t, e), x(t) ? t === d || t == null || t === "" ? (this._$AH !== d && this._$AR(), this._$AH = d) : t !== this._$AH && t !== A && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : St(t) ? this.k(t) : this._(t);
  }
  O(t) {
...
class k {
  ...
  _$AI(t, e = this, s, i) {
    ...
    let o = !1;
    if (n === void 0) t = b(this, t, e, 0), o = !x(t) || t !== this._$AH && t !== A, o && (this._$AH = t);
    else {
      const h = t;
      let a, l;
      for (t = n[0], a = 0; a < n.length - 1; a++) l = b(this, h[s + a], e, a), l === A && (l = this._$AH[a]), o ||= !x(l) || l !== this._$AH[a], l === d ? t = d : t !== d && (t += (l ?? "") + n[a + 1]), this._$AH[a] = l;
    }
    o && !i && this.j(t);
  }
  j(t) {
...
class kt extends v {
  ...
  render() {
    return this.chargerState === null ? C`
        <div class="status">
  ...
  renderMetric(t, e) {
    const s = this.chargerState?.roles[e], i = s?.available === !0 ? s.state ?? "unavailable" : "unavailable";
    return C`
      <div class="metric">
...
class Ht extends v {
  ...
  render() {
    return this.connectionError !== null ? C`
        <ha-card>
